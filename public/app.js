...
// ═══ TRACKING ═════════════════════════════════════════════════
function openTrack(){$('track-modal').classList.add('open');$('track-overlay').classList.add('open');lockScroll();const saved=JSON.parse(localStorage.getItem('loriginal_customer')||'{}');if(saved.phone)$('track-phone').value=saved.phone;}
